...
function StreamerModeToggle() {
  ...
  return (
    <section className="rounded-3xl border border-border bg-card/40 p-6 backdrop-blur">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-bold">Streamer mode (Twitch chat voting)</h2>
          <p className="mt-1 text-xs text-muted-foreground">
            Off by default — it's distracting on the host TV. Turn it on here only if you want Twitch chat to vote A/B/C/D during questions.
          </p>
        </div>
        <button
          type="button"
